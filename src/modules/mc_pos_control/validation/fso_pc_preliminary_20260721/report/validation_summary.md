...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| STD_L06_PID_AS | 是 | 否 | 0.389/0.262 | —/— | —% | 0.059 | 1.686/4.947 | 0.474 | 0.07% |
| STD_L06_PID_AS_FSOPC | 是 | 否 | 0.054/0.039 | —/— | —% | 0.056 | 1.676/5.086 | 0.267 | 0.04% |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| STD_L06_PID_AS | 否 | —/— | —/— | —/—/— | —/—/— | —/—/— | —～—/—% |
| STD_L06_PID_AS_FSOPC | 否 | —/— | —/— | —/—/— | —/—/— | —/—/— | —～—/—% |

## 自动有效性

- `STD_L06_PID_AS`：非 Z 基础飞行有效性和 VFB 专项有效性均通过。
- `STD_L06_PID_AS_FSOPC`：非 Z 基础飞行有效性和 VFB 专项有效性均通过。
